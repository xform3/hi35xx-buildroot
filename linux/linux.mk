...
define LINUX_KCONFIG_FIXUP_CMDS
	...
	$(if $(BR2_LINUX_KERNEL_EXT_SOUND),
		$(call KCONFIG_ENABLE_OPT,CONFIG_SOUND,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_SND,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_SND_SUPPORT_OLD_API,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_SND_VERBOSE_PROCFS,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_SND_DMA_SGBUF,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_SND_DRIVERS,$(@D)/.config)
		$(call KCONFIG_ENABLE_OPT,CONFIG_SND_USB,$(@D)/.config)

		$(call KCONFIG_SET_OPT,CONFIG_SND_USB_AUDIO,m,$(@D)/.config)
		$(call KCONFIG_SET_OPT,CONFIG_SND_USB_UA101,m,$(@D)/.config)
		$(call KCONFIG_SET_OPT,CONFIG_SND_USB_USX2Y,m,$(@D)/.config)
		$(call KCONFIG_SET_OPT,CONFIG_SND_USB_CAIAQ,m,$(@D)/.config)
		$(call KCONFIG_SET_OPT,CONFIG_SND_USB_US122L,m,$(@D)/.config)
		$(call KCONFIG_SET_OPT,CONFIG_SND_USB_6FIRE,m,$(@D)/.config))
